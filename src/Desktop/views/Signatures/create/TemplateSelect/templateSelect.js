                                                        ...
                                                        <tr>
                                                            ...
                                                            height="24"
                                                                ...
                                                                <table class="x_MsoTableGrid" border="0" cellspacing="0"
                                                                    ...
                                                                    <tbody height="24">
                                                                        <tr height="24">
                                                                            <td height="24" width="24" style="height:24px; width:24px; margin: 0 auto; text-align: left; padding: 0 2px;" valign="top">
                                                                                ...
                                                                                <img height="24"
                                                                                        ...
                                                                                        src="{{ absolute_url(asset('images//iconmonstr-facebook-4-48-1-61cc73165961b.png')) }}"
                                                                                        alt='' />
                                                                                </a>
                                                                            </td>
                                                                            <td height="24" width="24" style="height:24px; width:24px; margin: 0 auto; text-align: left; padding: 0 2px;" valign="top">
                                                                            ...
                                                                            <img height="24"
                                                                                    width="24"
                                                                                    style="vertical-align: middle; display: block; height:24px; width:24px; line-height:24px;"
                                                                                    src="{{ absolute_url(asset('images//iconmonstr-linkedin-4-48-61cc7336e67e8.png')) }}"
                                                                                    alt='' />
                                                                            </a>
                                                                        </td>
                                                                        <td height="24" width="24" style="height:24px; width:24px; margin: 0 auto; text-align: left; padding: 0 2px;" valign="top">
                                                                        ...
                                                                        <img height="24"
                                                                                width="24"
                                                                                style="vertical-align: middle; display: block; height:24px; width:24px; line-height:24px;"
                                                                                src="{{ absolute_url(asset('images//iconmonstr-twitter-4-48-61cc7355e7d05.png')) }}"
                                                                                alt='' />
                                                                        </a>
                                                                    </td>
                                                                    <td height="24" width="24" style="height:24px; width:24px; margin: 0 auto; text-align: left; padding: 0 2px;" valign="top">
                                                                    ...
                                                                    <img height="24"
                                                                            width="24"
                                                                            style="vertical-align: middle; display: block; height:24px; width:24px; line-height:24px;"
                                                                            src="{{ absolute_url(asset('images//iconmonstr-instagram-14-48-61cc732d0e0eb.png')) }}"
                                                                            alt='' />
                                                                    </a>
                                                                </td>
                                                                <td height="24" width="24" style="height:24px; width:24px; margin: 0 auto; text-align: left; padding: 0 2px;" valign="top">
                                                                ...
                                                                <img height="24"
                                                                        width="24"
                                                                        style="vertical-align: middle; display: block; height:24px; width:24px; line-height:24px;"
                                                                        src="{{ absolute_url(asset('images//iconmonstr-snapchat-4-48-61cc734da01ca.png')) }}"
                                                                        alt='' />
                                                                </a>
                                                            </td>
                                                            <td height="24" width="24" style="height:24px; width:24px; margin: 0 auto; text-align: left; padding: 0 2px;" valign="top">
                                                            ...
                                                            <img height="24"
                                                                    width="24"
                                                                    style="vertical-align: middle; display: block; height:24px; width:24px; line-height:24px;"
                                                                    src="{{ absolute_url(asset('images//iconmonstr-pinterest-1-48-61cc73437269b.png')) }}"
                                                                    alt='' />
                                                            </a>
                                                        </td>
                                                                        </tr>
                                                            ...
                                                            <td style="width:55px; border: none; background:black; padding: 0cm; height: 24px" height="24">
                                                                <img height="24" style="vertical-align: middle; height: 24px;"
                                                                    src="{{ absolute_url(asset('images//mama-61c0f1b6cbc19.png')) }}" />
                                                            </td>
                                                        </tr>
                                                </table>
                                            </td>
