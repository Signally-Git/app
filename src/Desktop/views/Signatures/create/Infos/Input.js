...
function Input(props) {
    ...
    const handleFontStyle = (e) => {
        ...
        props.setContent({ ...props.content, [props.toChange]: { ...props.content[props.toChange], style: style } })
    }
    ...
    return (
        <div className={classes.container}>
            <div className={classes.inputColorSize}>
                ...
                <div className={`${classes.inputOptions} ${option === "text" ? classes.opened : ""}`}>
                    ...
                    <div
                        ...
                        style={{ background: props.content[props.toChange].color }}
                        onClick={() =>
            ...
            <div className={classes.optionsContainer}>
                {option === "color" ? (
                    <>
                        <div className={`${classes.optionContainer} ${classes.colorContainer}`} ref={color}>
                            <HexColorInput
                                className={classes.input}
                                color={props.content[props.toChange].color}
                                onChange={(e) => props.setContent({ ...props.content, [props.toChange]: { ...props.content[props.toChange], color: e } })}
                            />
                            <HexColorPicker
                    ...
                    option === "text" && (
                        <> <div className={classes.optionContainer}>
                            <form onChange={(e) => handleFontStyle(e)} onSubmit={(e) => handleClose(e)}>
