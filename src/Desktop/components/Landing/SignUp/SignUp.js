    ...
    const handleSignUp = async (e) => {
        ...
        if (!validateEmail(email)) {
            setError({
                content: (
                    <>
                        Veuillez vérifier votre adresse mail <ImCross />
                    </>
                ),
            });
        }
        if (!validateSiren(siren)) {
            setError({
                content: (
                    <>
                        Veuillez vérifier votre SIREN <ImCross />
                    </>
                ),
            });
        }
                ...
                .catch((err) => {
                    if (
                        ...
                        setError({
                            content: (
                                <>
                                    Cette société est déjà enregistrée sur
                                    Signally <ImCross />
                                </>
                            ),
                        });
                    if (
                        ...
                        setError({
                            content: (
                                <>
                                    Cet utilisateur est déjà enregistré sur
                                    Signally <ImCross />
                                </>
                            ),
                        });
