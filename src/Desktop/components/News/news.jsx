        ...
        <Carousel
            ...
            <div className={classes.tab}>
                {slide === 0 ?
                    ...
                    : slide === 1 ? <h5>Signature</h5>
                        : slide === 2 ? <h5>Collaborateurs</h5>
                            : slide === 3 ? <h5>Events</h5> : ""}
                <div className={classes.row}>
                    <ul className={classes.progress} style={{ height: height }}>
                        <li className={`${activeAcc ? classes.done : ""} ${slide === 0 ? classes.isActive : ""}`} onClick={() => setSlide(0)}>Compte</li>
                        <li className={`${activeSignature ? classes.done : ""} ${slide === 1 ? classes.isActive : ""}`} onClick={() => setSlide(1)}>Signature</li>
                    ...
                    <Carousel showIndicators={false} selectedItem={slide} showArrows={false} dynamicHeight={false} showThumbs={true}>
                        ...
                        <div className={classes.slide}>
                            <p>Vous n'avez pas encore importé de collaborateurs. Cliquez ci-dessous pour en ajouter et commencer à gérer vos équipes</p>
                            <Button color="orange" onClick={() => history.push('/teams/create-user')}>Gérer les collaborateurs</Button>
                        </div>
                        <div className={classes.slide}>
                            <p>Vous n'avez pas encore créé d'event. Cliquez ci-dessous pour en ajouter et programmer des campagnes de promotion</p>
                            <div className={classes.btnsContainer}>
                                <Button color="brown" onClick={() => setHide(true)}>Passer cette étape</Button>
                                <Button color="orange" onClick={() => history.push('/events')}>Ajouter des events</Button>
                            </div>
                        </div>
                    </Carousel>
                </div>
