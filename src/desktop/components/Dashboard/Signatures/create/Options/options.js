...
export default function Options(props) {
    ...
    useEffect(() => {
        props.setData({ ...props.data, event: { ...props.data?.event, display: `<img style="padding-bottom:${props?.data?.event?.padding}px;" src="${props?.data?.event?.list[0]?.banner?.path}" />` } })
            ...
            <div className={classes.container}>
                ...
                <div className={classes.checkToText}>
                    ...
                    {props.data.event.enabled ?
                        <>
                            <form onChange={(e) => props.setData({ ...props.data, event: { ...props.data.event, display: `<img style="padding-bottom:${props?.data?.event?.padding}px;" src="${JSON.parse(e.target.value).banner.path}" />`, selected: JSON.parse(e.target.value) } })}>
                            ...
                            <div className={classes.spacing}>
                                ...
                                <Range
                                    ...
                                    onChange={(range) => props.setData({ ...props.data, event: { ...props.data.event, padding: range, display: `<img style="padding-bottom:${props?.data?.event?.padding}px;" src="${props?.data?.event?.selected.banner.path}" />` } })}
                                    renderTrack={({ props, children }) => (
                                        <div {...props} className={classes.rangeSlider} style={{
                                            ...props.style,
                                        }}>
